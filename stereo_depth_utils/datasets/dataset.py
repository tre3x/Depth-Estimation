...
class DrivingStereoDataset(Dataset):
    ...
    def __getitem__(self, index):
        left_img = self.load_image(self.left_imagepath)
        right_img = self.load_image(self.right_imagepath)
        ...
        #right_img = right_img.crop((w - crop_w, h - crop_h, w, h))
        #disparity = disparity[h - crop_h:h, w - crop_w: w]
        left_img = left_img.resize((640, 480), Image.ANTIALIAS)
        right_img = right_img.resize((640, 480), Image.ANTIALIAS)
